...
import { FiInbox, FiLogOut, FiMessageSquare, FiShoppingCart } from "react-icons/fi";
import { HiMenuAlt3 } from "react-icons/hi";
import { MdSearch } from "react-icons/md";
import { RiSettings4Line } from "react-icons/ri";
import { Link } from "react-router-dom";
const RightNav = ({ clickOnInbox,clickOnprofile }) => {
  ...
  const menus = [
    ...
    { name: "Status messages", link: "/", icon: FiMessageSquare },
